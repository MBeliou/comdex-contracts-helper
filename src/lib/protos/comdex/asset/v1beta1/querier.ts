...
export const PairInfo = {
  ...
  fromAmino(object: PairInfoAmino): PairInfo {
    return {
      id: BigInt(object.id),
      assetIn: BigInt(object.asset_in),
      denomIn: object.denom_in,
      assetOut: BigInt(object.asset_out),
  ...
  toAmino(message: PairInfo): PairInfoAmino {
    const obj: any = {};
    obj.id = message.id ? message.id.toString() : undefined;
    obj.asset_in = message.assetIn ? message.assetIn.toString() : undefined;
    obj.denom_in = message.denomIn;
    obj.asset_out = message.assetOut ? message.assetOut.toString() : undefined;
...
export const QueryPairsResponse = {
  ...
  fromAmino(object: QueryPairsResponseAmino): QueryPairsResponse {
    return {
      pairsInfo: Array.isArray(object?.pairsInfo) ? object.pairsInfo.map((e: any) => PairInfo.fromAmino(e)) : [],
      pagination: object?.pagination ? PageResponse.fromAmino(object.pagination) : undefined
    };
  },
...
export const QueryPairResponse = {
  ...
  fromAmino(object: QueryPairResponseAmino): QueryPairResponse {
    return {
      pairInfo: object?.pairInfo ? PairInfo.fromAmino(object.pairInfo) : undefined
    };
  },
