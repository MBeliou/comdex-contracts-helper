...
export const VaultInfo = {
  ...
  fromAmino(object: VaultInfoAmino): VaultInfo {
    return {
      ...
      debt: object?.debt ? Coin.fromAmino(object.debt) : undefined,
...
export const QueryVaultResponse = {
  ...
  fromAmino(object: QueryVaultResponseAmino): QueryVaultResponse {
    return {
      vaultInfo: object?.vaultInfo ? VaultInfo.fromAmino(object.vaultInfo) : undefined
    };
  },
...
export const QueryVaultsResponse = {
  ...
  fromAmino(object: QueryVaultsResponseAmino): QueryVaultsResponse {
    return {
      vaultsInfo: Array.isArray(object?.vaultsInfo) ? object.vaultsInfo.map((e: any) => VaultInfo.fromAmino(e)) : [],
